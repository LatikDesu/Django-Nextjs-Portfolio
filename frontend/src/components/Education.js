        ...
        <div className='my-64 md:my-32'>
            ...
            <div ref={ref} className='w-[75] mx-auto relative'>
                ...
                <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
                    <Details
                        type='Python разработчик'
                        place='SkillFactory'
                        time='2022-2023'
                        info='Worked on a team responsible for developing new features for Google
                    ...
                    <Details
                        ...
                        place='SkillFactory'
                        time='2022-2023'
                        info='Worked on a team responsible for developing Amazon`s mobile app, including implementing new features such
