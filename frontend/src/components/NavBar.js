...
import {PinterestIcon, GithubIcon, LinkedInIcon, TelegramIcon, SunIcon, MoonIcon} from "@/components/icons";
        ...
        '>
            ...
            '>
                        <nav className='flex items-center flex-col justify-center'>
                            ...
                            <CustomMobileLink href="/articles" title="Статьи" className='' toggle={handleClick}/>
                        </nav>
